  ...
  useEffect(() => {
    ...
    if (id) {
      ...
      const fetchTraveler = async () => {
        try {
          const response = await axios.get(`https://end-user.onrender.com/api/travelers/${id}`, {
            headers: {
    ...
    try {
      if (isEditing) {
        const response = await axios.put(
          `https://end-user.onrender.com/api/travelers/${id}`,
          {
        ...
        const response = await axios.post(
          "https://end-user.onrender.com/api/travelers",
          {
            first_name: formData.first_name,
            last_name: formData.last_name,
            prefix: formData.prefix
